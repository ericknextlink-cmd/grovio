      ...
      <div className="grid grid-cols-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4 px-2 md:px-0">
        {categories.map((category) => (
          <Link key={category.id} href={`/category/${category.id}`}>
            <div className="bg-white border border-gray-200 hover:border-[#D35F0E] transition-colors cursor-pointer group rounded-lg overflow-hidden aspect-[3/4] flex flex-col">
